...
{
    public delegate void KrAudioPlayerPlayStart();
    public class KrAudioPlayer
    {
        /// <summary>
        /// 播放开始的时间
        /// </summary>
        public event KrAudioPlayerPlayStart PlayStart;
        private SoundPlayer SP;
        /// <summary>
        /// 播放一个新的声音
        /// </summary>
        /// <param name="fileStream">声音流</param>
        public void Play(Stream fileStream)
        {
            SP = new SoundPlayer(fileStream);
            SP.Play();
            PlayStart();
        }
        /// <summary>
    ...
    public class WaveInfo
    {
        ...
        public WaveInfo(Stream WaveFileStream)
        {
            m_WaveData = WaveFileStream;
            try
            {
                LoadWave();
               // m_WaveData.Close();
